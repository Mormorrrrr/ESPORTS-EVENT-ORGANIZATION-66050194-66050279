                ...
                try {
                    ...
                    if (!openTournaments || openTournaments.length === 0) {
                        ...
                        openTournaments.slice(0, 3).forEach(t => {
                            ...
                            article.onclick = () => window.location.href=`../TournamentDetail Page 18/tournamentdetail_18.html?id=${t.tournament_id}`;
                            ...
                            article.innerHTML = `
                                ...
                                <div class="container-10">
                                    ...
                                    <button class="button-3" type="button" onclick="window.location.href='../TournamentDetail Page 18/tournamentdetail_18.html?id=${t.tournament_id}'">
                                        View
                                    </button>
                                </div>
                            `;
                        ...
                        for (const tMatches of Object.values(tournamentGroups)) {
                            ...
                            try {
                                ...
                                if (tdRes.ok) {
                                    ...
                                    // Populate Round 1 Winner Bracket if names are null
                            ...
                            } catch (e) { console.warn('Could not fetch tournament details for name resolution', tid); }
